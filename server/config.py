...
class Settings(BaseSettings):
    ...
    SPACE_COLOSSUS_HARBOR_WORLD_ID: str = "00000000-0000-4000-8000-000000000005"
    SPACE_COLOSSUS_HARBOR_WORLD_SEED: int = 42
    SPACE_TITAN_CANYON_WORLD_ID: str = "00000000-0000-4000-8000-000000000006"
    SPACE_TITAN_CANYON_WORLD_SEED: int = 42
    SPACE_ASTRAL_FOUNDRY_WORLD_ID: str = "00000000-0000-4000-8000-000000000007"
    SPACE_ASTRAL_FOUNDRY_WORLD_SEED: int = 42
    SPACE_BRUTALIST_DUSK_WORLD_ID: str = "00000000-0000-4000-8000-000000000008"
    SPACE_BRUTALIST_DUSK_WORLD_SEED: int = 42
    SPACE_MIXED_WORLD_ID: str = "00000000-0000-4000-8000-000000000009"
